...
(function(obj) {
    ...
    /**  2018-8-16 修改等待提示框 修改放置区域  默认在文档的body中,有参数传入的时候到对应的元素中
     * 显示等待框
     * @return {[type]} [description]
     */
    zeroModal.loading = function(type,$parent) {
        ...
        if (type === 1 || type === 2) {
            ...
            $parent == null ? $('body').append('<div role="zeromodal-loading" zero-unique-loading="' + params.unique + '" class="' + loadClass + '" style="z-index:' + _tmp_last_zindex + ';top:' + _top + 'px;"></div>') : $parent.append('<div role="zeromodal-loading" zero-unique-loading="' + params.unique + '" class="' + loadClass + '" style="z-index:' + _tmp_last_zindex + ';top:' + _top + 'px;"></div>') ;
            ...
            _html += '  </div>';
            $parent == null ? $('body').append(_html) : $parent.append(_html);
