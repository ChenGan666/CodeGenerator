  ...
  getInterpolateFunction(c) {
    ...
    if (!swiper.controller.spline) {
      swiper.controller.spline = swiper.params.loop
        ? new BaseController.LinearSpline(swiper.slidesGrid, c.slidesGrid)
        : new BaseController.LinearSpline(swiper.snapGrid, c.snapGrid);
    }
  },
  ...
  create() {
    ...
    Utils.extend(swiper, {
      controller: {
        ...
        getInterpolateFunction: BaseController.getInterpolateFunction.bind(swiper),
        setTranslate: BaseController.setTranslate.bind(swiper),
        setTransition: BaseController.setTransition.bind(swiper),
      },
    });
  },
  on: {
...
export { Swiper, virtual as Virtual, keyboard as Keyboard, mousewheel as Mousewheel, navigation as Navigation, pagination as Pagination, scrollbar as Scrollbar, parallax as Parallax, zoom as Zoom, lazy as Lazy, controller as BaseController, a11y$1 as A11y, history as History, hashNavigation as HashNavigation, autoplay as Autoplay, effectFade as EffectFade, effectCube as EffectCube, effectFlip as EffectFlip, effectCoverflow as EffectCoverflow };
