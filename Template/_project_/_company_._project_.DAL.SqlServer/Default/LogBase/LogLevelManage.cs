...
namespace _company_._project_.DAL.SqlServer
{
    public partial class LogLevelManage : ILogLevelManage
    {
        ...
        ///表名称
        private const string LogLevelTableName = "LogLevel";
        ///表字段
        ...
        public int LogLevel_Add(LogLevel model)
        {
            ...
            SqlParameter[] parameters = {
			 new SqlParameter("@LevelName", SqlDbType.NVarChar,100),
 new SqlParameter("@LevelRemarks", SqlDbType.NVarChar,510),
...
strSql.Append("UpdateTime=@UpdateTime");
 ...
 parameters[5].Value = model.UpdateTime;
        ...
        public DataTable LogLevel_GetListByPage(int pageSize, int pageIndex, string strWhere, out int pagetotal, out int total, int orderType = 1, string showName = "*", string orderKey = "Id")
        {
            ...
            DataSet ds = DbHelper.ExecuteDataset(DbConfig.GetDbInfo(LogLevelConnectionName),CommandType.StoredProcedure, "UP_GetRecordByPage", parameters);
            total = 0;
